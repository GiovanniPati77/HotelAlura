...
public class RegistroHuesped extends JFrame {
	...
	private void listart() {
		List<Object[]> datosList = ControllerUsuarios.listarReservas();
		for (Object[] lista: datosList) {
			Bienvenido numReserva = new Bienvenido("<html> Registro realizado con exito.<p> Su numero de Reservas es: <html>" + lista[0] );
			numReserva.setVisible(true);
			dispose();
		}
	}
	...
	public RegistroHuesped() {
		...
		txtNombre.setBounds(576, 169, 255, 33);
		contentPane.add(txtNombre);

		txtApellido = new JTextField();
		txtApellido.setColumns(10);
		txtApellido.setBackground(Color.WHITE);
		txtApellido.setBounds(576, 238, 255, 33);
		contentPane.add(txtApellido);

		JDateChooser txtFechaN = new JDateChooser();
		txtFechaN.getCalendarButton().setBackground(SystemColor.text);
		txtFechaN.setBounds(576, 307, 255, 33);
		contentPane.add(txtFechaN);

		JComboBox txtNacionalidad = new JComboBox();
		txtNacionalidad.setForeground(SystemColor.desktop);
		...
		txtNacionalidad.setBounds(576, 376, 255, 33);
		contentPane.add(txtNacionalidad);

		JLabel lblNewLabel_1 = new JLabel("Nombre");
		lblNewLabel_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(576, 144, 253, 14);
		contentPane.add(lblNewLabel_1);

		JLabel lblNewLabel_1_1 = new JLabel("Apellido");
		lblNewLabel_1_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1_1.setBounds(576, 213, 255, 14);
		contentPane.add(lblNewLabel_1_1);

		JLabel lblNewLabel_1_1_1 = new JLabel("Fecha de Nacimiento");
		lblNewLabel_1_1_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1_1_1.setBounds(576, 282, 255, 14);
		contentPane.add(lblNewLabel_1_1_1);

		JLabel lblNewLabel_1_1_1_1 = new JLabel("Nacionalidad");
		lblNewLabel_1_1_1_1.setFont(new Font("Arial", Font.PLAIN, 14));
		lblNewLabel_1_1_1_1.setBounds(576, 351, 255, 14);
		...
		btnGuardar.addActionListener(new ActionListener() {
			...
			private void ingresarHuesped() {
				String nombre = txtNombre.getText();
				String apellido = txtApellido.getText();
				String fechaNacimiento = (new SimpleDateFormat("yyyy-MM-dd").format(txtFechaN.getDate()));
				String nacionalidad = (String) txtNacionalidad.getSelectedItem().toString();
				String telefono = txtTelefono.getText();
				ControllerUsuarios huespedController = new ControllerUsuarios();
				huespedController.ingresarHuesped(nombre, apellido, fechaNacimiento, nacionalidad, telefono);
			}
		});
		...
		lblNewLabel_1_2.setBounds(578, 435, 253, 14);
		contentPane.add(lblNewLabel_1_2);

		txtTelefono = new JTextField();
		txtTelefono.setColumns(10);
		txtTelefono.setBackground(Color.WHITE);
		txtTelefono.setBounds(576, 460, 255, 33);
